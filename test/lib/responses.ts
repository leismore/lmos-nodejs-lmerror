...
const RESPONSE_HEADERS_NAME_ILLEGAL_CHARS = {
    statusCode : '204',
    headers    : [
        { name: 'X Date'  , value: 'Tue, 29 Oct 2024 16:56:32 GMT' },
        { name: 'Server%Y', value: 'Apache/2.4.1 (Unix)' }
    ]
};
...
const ALL = [
    ...
    RESPONSE_HEADERS_NAME_ILLEGAL_CHARS,
